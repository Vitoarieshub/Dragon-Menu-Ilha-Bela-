...
-- Conexões entre partes do corpo (R15)
...
-- Criar linhas de esqueleto para um jogador
...
local function updateSkeletons()
    ...
    for _, target in pairs(Players:GetPlayers()) do
        ...
        if target ~= player then
            ...
            if character and skeleton then

                for i, connection in ipairs(partsToConnect) do
                    ...
                    if part0 and part1 and espEnabled then
...
-- Botão para ativar/desativar ESP esqueleto
